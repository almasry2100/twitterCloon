...
public class sendTweetActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //FancyToast.makeText( this, numbers.get( "number1" )+"",FancyToast.WARNING,Toast.LENGTH_SHORT ,true).show();
    ...
    public void sendTweet(View view){
        ...
        parseObject.saveInBackground( new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e==null){
                    FancyToast.makeText( sendTweetActivity.this,ParseUser.getCurrentUser().getUsername()+"  's tweet "+"("+ edtTweet.getText().toString() +")  is saved", FancyToast.LENGTH_LONG, FancyToast.SUCCESS, true ).show();
